...
Given a functor $\mathbb{A} \xrightarrow{J} \mathbb{B}$, an \textit{adjoint triangle} for $ J$ consists of a category $ \mathbb{C}$, and adjunctions $(E \dashv R, \rho, \mu): \mathbb{A} \to \mathbb{C}$ and  $(L \dashv U, \eta, \varepsilon): \mathbb{B} \to \mathbb{C}$ such that $ JR=U$, displayed in the diagram:
